function [cell_staging_to_inter_70, cell_staging_to_inter_path, cell_inter_to_inter_70, cell_inter_to_inter_path] = calc_between_inter_paths(staging_arr,inter_arr,panda_ec_orig, panda_sc_orig, env, params)
%CALC_BETWEEN_STAGING_PATHS Summary of this function goes here


num_positions = size(staging_arr,1);
