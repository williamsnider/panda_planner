function [q_arr, z_vals] = calc_cartesian_path_q1_q2(q1, q2, T1, T2, ik, robot, body_name, num_steps)
...
z_vals = linspace(T1(3,4),T2(3,4),num_steps);
...
assert(max(max(abs(diff(q_arr))))<0.001);
end
