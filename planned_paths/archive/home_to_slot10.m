...
slot_name = 'Slot10';
q_slot = [1.4371,0.828166,-1.28523,-1.37499,2.62942,2.80758,2.0875, 0.01, 0.01];
%% Common
...
%% Cartesian paths
[paths, all_valid] = calc_sequence_cartesian_paths(panda, poseArray,q_slot,window_size, num_waypoints, vMaxAll, aMaxAll, jMaxAll,vMaxAllAbsolute, aMaxAllAbsolute, jMaxAllAbsolute, jointMin, jointMax);
...
% Check
assert(all(abs(slot_to_above(1,1:7)-q_slot(1:7))<1e-5))
