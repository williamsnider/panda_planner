classdef ManipulatorStateValidatorEllipsoid < robotics.manip.internal.InternalAccess
    ...
    methods
        function obj = ManipulatorStateValidatorEllipsoid(ss, env, validationDistance,ellipsoid_radius_offset, params)
            ...
            obj.ellipsoid_origin = obj.params.ellipsoid_origin;
            obj.ellipsoid_r1 = obj.params.ellipsoid_r1;
            obj.ellipsoid_r2 = obj.params.ellipsoid_r2;
            obj.ellipsoid_r3 = obj.params.ellipsoid_r3;
            obj.ellipsoid_radius_offset = obj.params.ellipsoid_radius_offset;
        ...
        function valid = isStateValid(obj, state)
            ...
            for i = 1:numStates
                ...
                % Check that collision mesh within ellipsoid
                ...
                for j = 1:numel(mesh_names)
                    ...
                    % Check if within ellipsoid AND below/above cutoffs
                    xyz_shift = xyz_base - obj.ellipsoid_origin;
                    r1 = obj.ellipsoid_r1 - obj.ellipsoid_radius_offset;
                    r2 = obj.ellipsoid_r2 - obj.ellipsoid_radius_offset;
                    r3 = obj.ellipsoid_r3 - obj.ellipsoid_radius_offset;
                    norm_coords = [xyz_shift(:,1)/r1, xyz_shift(:,2)/r2, xyz_shift(:,3)/r3];
                    within_ellipsoid = sum(norm_coords.^2, 2) <= 1;

                    % Check if within bottom cylinder
                    vc1=[0,0,-obj.params.cylinder_height/2 + obj.params.ellipsoid_cutoff_bottom]';
                    vc2=[0,0, obj.params.cylinder_height/2+ obj.params.ellipsoid_cutoff_bottom]';
                    d=2*obj.params.bottom_cylinder_radius;
                    within_bottom=CheckPointCylinder(vc1,vc2,d,xyz_base')';

                    % Check if within top cylinder
                    vc1=[0,0,-obj.params.cylinder_height/2 + obj.params.ellipsoid_cutoff_top]';
                    vc2=[0,0, obj.params.cylinder_height/2+ obj.params.ellipsoid_cutoff_top]';
                    ...
                    all_valid = (within_ellipsoid|within_bottom|within_top|within_staging_box);
